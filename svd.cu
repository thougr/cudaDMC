...
namespace svd
{
    ...
    __host__ __device__ static void calcSymmetricGivensCoefficients(const float a_pp,
    ...
    __host__ __device__ static void rotate01(SMat3 &vtav, Mat3 &v)
    {
        if (vtav.m01 == 0) {
            return;
        }
    ...
    __host__ __device__ static void rotate02(SMat3 &vtav, Mat3 &v)
    {
        if (vtav.m02 == 0) {
            return;
        }
    ...
    __host__ __device__ static void rotate12(SMat3 &vtav, Mat3 &v)
    {
        if (vtav.m12 == 0) {
            return;
        }
    ...
    __host__ __device__ static float calcError(const SMat3 &origA, const Vec3 &x,
                            const Vec3 &b)
    {
        Mat3 A;
        Vec3 vtmp;
    ...
    __host__ __device__ static float pinv(const float x, const float tol)
    {
